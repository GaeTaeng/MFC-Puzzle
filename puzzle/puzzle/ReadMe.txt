...
puzzleDoc.h, puzzleDoc.cpp - 문서
    이 파일에는 CpuzzleDoc 클래스가 포함됩니다. 이 파일을 편집하여 특수 문서 데이터를 추가하고 CpuzzleDoc::Serialize를 통해 파일 저장 및 로드를 구현합니다.

puzzleView.h, puzzleView.cpp - 문서 뷰
    이 파일에는 CpuzzleView 클래스가 포함됩니다.
    CpuzzleView 개체는 CpuzzleDoc 개체를 보는 데 사용됩니다.
